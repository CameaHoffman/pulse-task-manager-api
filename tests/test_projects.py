...
def test_get_projects_list_returns_projects(client):
...
def test_get_projects_respects_limit(client):
    payload1 = {"name": "Project One"}
    payload2 = {"name": "Project Two"}
    ...
    client.post("/projects", json=payload1)
    client.post("/projects", json=payload2)
    client.post("/projects", json=payload3)
...
def test_get_projects_respects_limit_and_offset(client):
    payload1 = {"name": "Project One"}
    payload2 = {"name": "Project Two"}
    payload3 = {"name": "Project Three"}
...
def test_patch_project_name_returns_200_ok(client):
...
def test_patch_project_name_returns_404_when_not_found(client):
...
def test_delete_project_by_id_returns_204_success_no_content(client):
...
def test_delete_project_by_id_returns_404_when_not_found(client):
